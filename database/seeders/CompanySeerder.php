    ...
    public function run()
    {
        $entities = [
            ...
            [
                ...
                'sector_id' => 5,
                'subsector_id' => 5,
                'subsector' => 'Corretoras de Seguros e Resseguros',
            ],
            [
                'name' => 'BB Seguridade',
            ...
            [
                ...
                'sector_id' => 1,
                'subsector_id' => 9,
                'subsector' => 'Máq. e Equip. Industriais',
            ],
        ];
